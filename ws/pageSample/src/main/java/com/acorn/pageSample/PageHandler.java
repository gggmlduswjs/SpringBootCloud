...
public class PageHandler {
	 ...
	 int  grpEndPage;             // 현재그룹의 마지막번호
	    ...
	    //현재페이지, 전체레코드수, 페이지사이즈(한 페이지에 보이는 글의 수) , 그룹사이즈 [  1   2   3  4  5  ]  하단에 보이는 페이지 수
	...
	private void calcPage(){
		 ...
		 grpStartPage = ( currentGrp -1 ) * grpSize +1 ;  // 그룹의 시작번호   현재그룹 1 => 1  , 현재그룹 2 -> 6    //이전그룹의 마지막+1 
		 grpEndPage = currentGrp * grpSize;               // 그룹의 끝번호    1-> 5  , 2-> 10		    //현재그룹 *그룹의 사이즈 
