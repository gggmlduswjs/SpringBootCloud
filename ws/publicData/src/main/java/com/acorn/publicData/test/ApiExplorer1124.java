...
public class ApiExplorer1124 {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("searchDate","UTF-8") + "=" + URLEncoder.encode("2025-11-24", "UTF-8")); /*통보시간 검색(조회 날짜 입력이 없을 경우 한달동안 예보통보 발령 날짜의 리스트 정보를 확인)*/
       ...
       // conn.setRequestProperty("Content-type", "application/json");   //get요청은 의미 없음
